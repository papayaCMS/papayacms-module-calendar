...
* @version $Id: actbox_nextdates_tag.php 39734 2014-04-08 19:01:37Z weinert $
*/
...
class actionbox_nextdates_tag extends base_actionbox {
  ...
  */
  function callbackSelectedTag($name, $element, $data) {
    $result = '';
    $tag = $this->tagSelector->getTag($data, $this->papaya()->administrationLanguage->id);
    $result .= sprintf(
